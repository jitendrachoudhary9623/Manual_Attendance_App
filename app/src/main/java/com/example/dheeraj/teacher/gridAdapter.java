...
public class gridAdapter extends BaseAdapter{
    ...
    public View getView(int position, View v, ViewGroup parent) {
        ...
        if(names.get(position).toString().equals("TAKE ATTENDANCE"))
        {
            imageView.setImageResource(R.drawable.ic_launcher_calender);
        ...
        {
            imageView.setImageResource(R.drawable.ic_launcher_sch);
            v.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
        ...
        }else if(names.get(position).toString().equals("ADD SUBJECT\n"))
        {
            imageView.setImageResource(R.drawable.ic_launcher_yellownote);
            v.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
        ...
        }else if(names.get(position).toString().equals("SEARCH / ADD STUDENT"))
        {
            imageView.setImageResource(R.drawable.ic_launcher_boy);
            v.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
        ...
        {
            imageView.setImageResource(R.drawable.ic_launcher_cgpacalculator);
            v.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
        ...
        else if(names.get(position).toString().equals("GENERATE DEFAULTER LIST"))
        {
            imageView.setImageResource(R.drawable.ic_launcher_seo);
            v.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {

                    Intent launchinIntent = new Intent(activity, defaulter_activity.class);
                    activity.startActivity(launchinIntent);
                }
            });
            Animation anim = new ScaleAnimation(
            ...
            anim.setRepeatCount(Animation.INFINITE);
            imageView.startAnimation(anim);
        }else if(names.get(position).toString().equals("GENERATE PDF"))
        {
            imageView.setImageResource(R.drawable.ic_launcher_seo);
            v.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    ...
                    Intent launchinIntent = new Intent(activity, PDFAcitivity.class);
                    activity.startActivity(launchinIntent);
                }
            });
            Animation anim = new ScaleAnimation(
                        ...
                        public void onClick(DialogInterface dialog, int id) {
                            ...
                            if(cursor==null||cursor.getCount()==0)
                            {
                              ...
                              //  Toast.makeText(getActivity(),"Period Already Added",Toast.LENGTH_LONG).show();
                                Toasty.warning(getActivity(),"Lecture Already Added",Toast.LENGTH_LONG).show();
...
//        notificationIntent.putExtra(MainListAdapter.IS_EMERGENCY, true);
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(activity.getBaseContext())
                .setTicker("Ticker Title").setContentTitle("Information Are Available For this subject Teacher")
