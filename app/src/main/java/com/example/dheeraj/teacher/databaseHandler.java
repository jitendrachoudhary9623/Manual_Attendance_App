...
public class databaseHandler {
    ...
    public void createTable()
    {
       ...
       //     Toast.makeText(activity,"Error Occured for create table",Toast.LENGTH_LONG).show();
            Toasty.error(activity, "Error Occured for create table", Toast.LENGTH_LONG).show();
    ...
    public boolean execAction(String qu)
    {
        ...
        }catch (Exception e)
        {
           ...
           // Toast.makeText(activity,"Error Occured for execAction",Toast.LENGTH_LONG).show();
            Toasty.error(activity,"Error Occured for execAction",Toast.LENGTH_LONG).show();
    ...
    Cursor execQuery(String qu)
    {
        ...
        }catch (Exception e)
        {
            Log.e("databaseHandler", qu);
//         //   Toast.makeText(activity,"Error Occured for execAction",Toast.LENGTH_LONG).show();
            Toasty.warning(activity,"Error Occured for execAction",Toast.LENGTH_LONG).show();
        }
        return null;
    }
}
