...
public class noteActivity extends AppCompatActivity implements ListView.OnItemClickListener,ListView.OnItemLongClickListener{
    ...
    private void loadNotes() {
        ...
        if(cursor==null||cursor.getCount()==0)
        {
            ...
            Toasty.warning(getBaseContext(), "No Notes Found", Toast.LENGTH_LONG).show();
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (AppBase.handler.execAction(qu)) {
                   ...
                   // Toast.makeText(getBaseContext(), "Deleted", Toast.LENGTH_LONG).show();
                    Toasty.success(getBaseContext(), "Deleted", Toast.LENGTH_LONG).show();

                } else {
                    loadNotes();
                    Toasty.error(getBaseContext(), "Failed", Toast.LENGTH_LONG).show();
                }
                dialog.dismiss();
            }
        });
